...
# We are under other system, may be Linux. Assume using gcc.
	# Can we use -fdata-sections?
	ESPPORT ?=  /dev/cu.usbserial-AJV9MSUG
...
MODULES		= driver mqtt user modules i2c oled graphics
...
flash: $(FW_FILE_1)  $(FW_FILE_2)
	$(ESPTOOL) --port $(ESPPORT) --baud 921600 write_flash $(FW_2) $(FW_FILE_2) $(FW_1) $(FW_FILE_1) 
